...
\.
COPY public.auth_group (id, name) FROM '/data/physical_verification_data/3426.dat';
...
\.
COPY public.auth_group_permissions (id, group_id, permission_id) FROM '/data/physical_verification_data/3428.dat';
...
\.
COPY public.auth_permission (id, name, content_type_id, codename) FROM '/data/physical_verification_data/3425.dat';
...
\.
COPY public.auth_user (id, password, last_login, is_superuser, username, first_name, last_name, email, is_staff, is_active, date_joined) FROM '/data/physical_verification_data/3429.dat';
...
\.
COPY public.auth_user_groups (id, user_id, group_id) FROM '/data/physical_verification_data/3431.dat';
...
\.
COPY public.auth_user_user_permissions (id, user_id, permission_id) FROM '/data/physical_verification_data/3433.dat';
...
\.
COPY public.customers_customer (id, datetime_created, datetime_updated, first_name, last_name, mobile) FROM '/data/physical_verification_data/3441.dat';
...
\.
COPY public.django_admin_log (id, action_time, object_id, object_repr, action_flag, change_message, content_type_id, user_id) FROM '/data/physical_verification_data/3435.dat';
...
\.
COPY public.django_content_type (id, app_label, model) FROM '/data/physical_verification_data/3424.dat';
...
\.
COPY public.django_migrations (id, app, name, applied) FROM '/data/physical_verification_data/3423.dat';
...
\.
COPY public.django_session (session_key, session_data, expire_date) FROM '/data/physical_verification_data/3448.dat';
...
\.
COPY public.employees_employee (id, datetime_created, datetime_updated, first_name, last_name, mobile, role_id) FROM '/data/physical_verification_data/3445.dat';
...
\.
COPY public.employees_role (id, datetime_created, datetime_updated, role) FROM '/data/physical_verification_data/3443.dat';
...
\.
COPY public.loan_applications_loanapplication (id, datetime_created, datetime_updated, status, verification_status, manager_id, reviewer_id, loan_amount, customer_id, verifier_id) FROM '/data/physical_verification_data/3447.dat';
...
\.
COPY public.verification_documents_verificationdocument (id, datetime_created, datetime_updated, document_type, loan_application_id, file_path) FROM '/data/physical_verification_data/3450.dat';
